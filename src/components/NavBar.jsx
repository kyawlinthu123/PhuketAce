    ...
    <nav className='font-nunito'>
            <ul className='flex justify-around items-start p-3 mx-auto'>
                <li className='flex items-center'>
                    <Link to=' '>
                        <p className='text-3xl font-bold text-primary'>PhuketAce</p>
                    </Link>
                </li>
                ...
                <li className='flex items-center'>
                    <Link to="/create" className='text-white bg-red-500 px-3 py-2 md:rounded-full flex items-center gap-1'>
